...
<p align="center">
  <img src="../images/pdf2-336.png" alt="Three-panel diagram showing high-frequency stimulation: (1) presynaptic terminal releasing large glutamate burst; (2) AMPA channels open with large Na⁺ influx; (3) Mg²⁺ ejected from NMDA channel allowing Na⁺ and Ca²⁺ entry" width="600">
</p>

*Three-panel diagram showing high-frequency stimulation: (1) presynaptic terminal releasing large glutamate burst; (2) AMPA channels open with large Na⁺ influx; (3) Mg²⁺ ejected from NMDA channel allowing Na⁺ and Ca²⁺ entry*
...
<p align="center">
  <img src="../images/pdf2-338.png" alt="Early phase LTP diagram: Ca²⁺ binding to proteins triggers insertion of new AMPA receptors from intracellular stores into postsynaptic membrane" width="600">
</p>

*Early phase LTP diagram: Ca²⁺ binding to proteins triggers insertion of new AMPA receptors from intracellular stores into postsynaptic membrane*
...
<p align="center">
  <img src="../images/pdf2-340.png" alt="New synapse formation diagram: growth factors lead to structural changes and formation of new synaptic connections between neurons" width="600">
</p>

*New synapse formation diagram: growth factors lead to structural changes and formation of new synaptic connections between neurons*
...
<p align="center">
  <img src="../images/pdf2-348.png" alt="Morris water maze probe trial swim paths: (1) Control (saline) — mice swim to former platform location in top-right quadrant; (2) DL-AP5 group (2133 μg) — mice swim randomly across the maze; (3) L-AP5 group (2157 μg) — mice swim randomly, showing NMDA blockade impairs spatial memory formation" width="600">
</p>

*Morris water maze probe trial swim paths: (1) Control (saline) — mice swim to former platform location in top-right quadrant; (2) DL-AP5 group (2133 μg) — mice swim randomly across the maze; (3) L-AP5 group (2157 μg) — mice swim randomly, showing NMDA blockade impairs spatial memory formation*
