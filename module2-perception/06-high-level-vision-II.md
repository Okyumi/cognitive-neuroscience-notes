...
[← Back to Main Contents](../README.md) | [← Previous Lecture](05-high-level-vision-I.md) | [Next Lecture →](07-kanwisher-discussion.md)
...
<p align="center">
  <img src="../images/pdf1-186.png" alt="Grid of diverse human faces" width="600">
</p>

*Grid of diverse human faces*
...
<p align="center">
  <img src="../images/pdf1-187.png" alt="A: Thatcher illusion (inverted vs. upright faces); B: Composite illusion; C: Part-whole illusion" width="600">
</p>

*A: Thatcher illusion (inverted vs. upright faces); B: Composite illusion; C: Part-whole illusion*

<p align="center">
  <img src="../images/pdf1-188.png" alt="Composite face task: aligned vs. misaligned, upright vs. inverted, with RT bar chart" width="600">
</p>

*Composite face task: aligned vs. misaligned, upright vs. inverted, with RT bar chart*
...
<p align="center">
  <img src="../images/pdf1-189.png" alt="Bar charts: % Correct for patient LH (left) and controls (right) — Upright vs. Inverted face orientation" width="600">
</p>

*Bar charts: % Correct for patient LH (left) and controls (right) — Upright vs. Inverted face orientation*
...
<p align="center">
  <img src="../images/pdf1-190.png" alt="Spatiotemporal scales of neural signals: chart comparing fMRI, EEG, MEG, ECoG, LFP, Optical Imaging, Spikes across time and space axes" width="600">
</p>

*Spatiotemporal scales of neural signals: chart comparing fMRI, EEG, MEG, ECoG, LFP, Optical Imaging, Spikes across time and space axes*

<p align="center">
  <img src="../images/pdf1-191.png" alt="Photo of an MRI scanner in a clinical setting" width="600">
</p>

*Photo of an MRI scanner in a clinical setting*
...
<p align="center">
  <img src="../images/pdf1-192.png" alt="Diagrams of proton magnetic moments: random orientation (left), applied B₀ field aligning protons (right)" width="600">
</p>

*Diagrams of proton magnetic moments: random orientation (left), applied B₀ field aligning protons (right)*
...
<p align="center">
  <img src="../images/pdf1-197.png" alt="Transmit and receive coil diagrams with proton tipping and relaxation" width="600">
</p>

*Transmit and receive coil diagrams with proton tipping and relaxation*
...
<p align="center">
  <img src="../images/pdf1-198.png" alt="MRI brain scans showing axial (left) and sagittal (right) views highlighting tissue contrast" width="600">
</p>

*MRI brain scans showing axial (left) and sagittal (right) views highlighting tissue contrast*
...
<p align="center">
  <img src="../images/pdf1-199.png" alt="Diagram: Inference of Neural Signal Estimation — showing pathway from Neuronal Activity → Cerebral Blood Flow → Cerebral Blood Volume → Deoxyhemoglobin Concentration → BOLD fMRI Signal" width="600">
</p>

*Diagram: Inference of Neural Signal Estimation — showing pathway from Neuronal Activity → Cerebral Blood Flow → Cerebral Blood Volume → Deoxyhemoglobin Concentration → BOLD fMRI Signal*
...
<p align="center">
  <img src="../images/pdf1-200.png" alt="Diagrams: Resting vs. Activated blood vessels (oxygen/hemoglobin); T2* contrast image (functional) and T1 contrast image (structural) brain scans; fMRI signal trace" width="600">
</p>

*Diagrams: Resting vs. Activated blood vessels (oxygen/hemoglobin); T2* contrast image (functional) and T1 contrast image (structural) brain scans; fMRI signal trace*
...
<p align="center">
  <img src="../images/pdf1-201.png" alt="BOLD response curve over time: initial dip, peak (~5s), post-stimulus undershoot, returning to baseline by ~25s. Stimulus marker at time 0." width="600">
</p>

*BOLD response curve over time: initial dip, peak (~5s), post-stimulus undershoot, returning to baseline by ~25s. Stimulus marker at time 0.*
...
<p align="center">
  <img src="../images/pdf1-202.png" alt="fMRI data hierarchy: subjects → sessions → runs → single run → volume → slices → voxel; TR = repetition time = time required to scan one volume" width="600">
</p>

*fMRI data hierarchy: subjects → sessions → runs → single run → volume → slices → voxel; TR = repetition time = time required to scan one volume*

<p align="center">
  <img src="../images/pdf1-203.png" alt="Diagram of a single brain slice showing voxel grid; voxel size example: 3.75 mm × 3.75 mm × 5 mm" width="600">
</p>

*Diagram of a single brain slice showing voxel grid; voxel size example: 3.75 mm × 3.75 mm × 5 mm*
...
<p align="center">
  <img src="../images/pdf1-204.png" alt="Subtraction method: Hand Clenching minus Rest → Statistical Parameter Map → Overlay onto Anatomical Image (showing Supplementary Motor Area and Primary Motor)" width="600">
</p>

*Subtraction method: Hand Clenching minus Rest → Statistical Parameter Map → Overlay onto Anatomical Image (showing Supplementary Motor Area and Primary Motor)*
