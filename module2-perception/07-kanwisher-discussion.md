# Discussion of Kanwisher et al. (2021-09-21)

> Course: PSYCH-UH 2412 Cognitive Neuroscience | NYU Abu Dhabi | Authors: Sean Shan Guangji & Yumi Omori

---

[← Back to Main Contents](../README.md) | [← Previous Lecture](06-high-level-vision-II.md) | [Next Lecture →](08-high-level-vision-III.md)
...
<p align="center">
  <img src="../images/pdf1-246.png" alt="Greeble novices and experts (Faces, Greebles) brain activations; Faces-objects vs. Cars-objects vs. Birds-objects activations; Greeble object images" width="600">
</p>

*Greeble novices and experts (Faces, Greebles) brain activations; Faces-objects vs. Cars-objects vs. Birds-objects activations; Greeble object images*
...
<p align="center">
  <img src="../images/pdf1-255.png" alt="Social media posts by note author (Chinese): Post about visiting the fMRI machine at NYU Abu Dhabi's Computational Research building — the first and only research fMRI in the Gulf region. Commentary about learning fMRI principles over 1.5 years and finally seeing it in person. Also mentions poor performance on the face-processing task (~20% lower accuracy than peers, attributed to sleep deprivation). Instagram post from noa_nostalgia (NYU Abu Dhabi) with similar content." width="600">
</p>

*Social media posts by note author (Chinese): Post about visiting the fMRI machine at NYU Abu Dhabi's Computational Research building — the first and only research fMRI in the Gulf region. Commentary about learning fMRI principles over 1.5 years and finally seeing it in person. Also mentions poor performance on the face-processing task (~20% lower accuracy than peers, attributed to sleep deprivation). Instagram post from noa_nostalgia (NYU Abu Dhabi) with similar content.*

<p align="center">
  <img src="../images/pdf1-256.png" alt="fMRI demonstration screenshot showing class announcement about the in-person fMRI demo, and classroom/lab photos with \"Handsome Kartik\" caption" width="600">
</p>

*fMRI demonstration screenshot showing class announcement about the in-person fMRI demo, and classroom/lab photos with "Handsome Kartik" caption*
